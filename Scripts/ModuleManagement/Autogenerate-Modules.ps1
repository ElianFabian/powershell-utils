...
function New-AutogenaratedModule($ModuleName, $DataTypeRegex, $DataTypeName)
{
    ...
    New-Item -Name $ModuleName            -Path "../../Modules/AutogeneratedModules/"             -ItemType Directory -Force
    New-Item -Name "$ModuleName.psm1"     -Path "../../Modules/AutogeneratedModules/$ModuleName/" -ItemType File      -Force -Value $autogeneratedFileContent.ToString()
}
