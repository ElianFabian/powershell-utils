...
$AUTOGENERATED_MODULES_FOLDER_NAME = "AutogeneratedModules"
$AUTOGENERATED_FROM_MODULES_NAME   = "AutogeneratedFromModules"
$AUTOGENERATOR_FILE_NAME           = "_Autogenerate.ps1"

$AUTOGENERATED_FROM_MODULES_FILE_PATH = @(
    $MODULES_PATH,
    $AUTOGENERATED_MODULES_FOLDER_NAME,
    $AUTOGENERATED_FROM_MODULES_NAME,
    "$AUTOGENERATED_FROM_MODULES_NAME.psm1"
) -join '/'
...
function New-AutogeneratedModule($ModuleName, $DataTypeRegex, $DataTypeName)
{
    $lineSeparator = "`n`n`n" 
    ...
    $filesToReadTheirPossibleDataTypes = Get-ChildItem -Path ..\..\Modules\* -File -Recurse | Where-Object {
        ...
        $_.DirectoryName -notmatch $AUTOGENERATED_MODULES_FOLDER_NAME
    }
    ...
    New-Item -Path "$MODULES_PATH/$AUTOGENERATED_MODULES_FOLDER_NAME/$ModuleName/$ModuleName.psm1" -Value $autogeneratedFileSB.ToString() -ItemType File -Force
}


New-AutogeneratedModule -ModuleName "AutogeneratedEnumModule" -DataTypeName "enum" -DataTypeRegex "enum \w+\s*\n?{[\S\s]*?}"
...
$autogenerateFiles = (Get-ChildItem -Path "$MODULES_PATH/" -Filter $AUTOGENERATOR_FILE_NAME -File -Recurse).FullName
...
New-Item -Path $AUTOGENERATED_FROM_MODULES_FILE_PATH -Value $autogeneratedFileFromModulesSB.ToString() -Force 
